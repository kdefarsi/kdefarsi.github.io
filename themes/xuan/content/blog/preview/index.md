...
文字可以**加粗**，*斜体*，~~删除线~~，**~~以及两者都~~**。

[跳转页面](@/archive/_index.md)
...
<figure>
{{ image(url="https://upload.wikimedia.org/wikipedia/commons/b/b4/JPEG_example_JPG_RIP_100.jpg", alt="Portal Gun blueprint", no_hover=true) }}
